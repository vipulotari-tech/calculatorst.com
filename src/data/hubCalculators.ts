...
export const hubCalculators: (CalculatorMeta & { cluster: string; category: string })[] = [
  ...
  },
  {
    ...
    "description": "Calculate paint coverage coverage — gallons, coats and containers for US interior and exterior painting.",
    "category": "Drywall & Paint",
    "cluster": "drywall",
    "iconPath": "M4 10l4-6 4 6H4ZM8 4v8",
    "keywords": [
  ...
  },
  {
    ...
    "description": "Estimate paint cost — material, quantity and price with waste. Compare per yard, per bag or per ton for US projects.",
    "category": "Drywall & Paint",
    "cluster": "drywall",
    "iconPath": "M4 10l4-6 4 6H4ZM8 4v8",
    "keywords": [
